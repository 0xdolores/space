...
export const createCodeSpace = async (
  ...
  if (environment === "reactjs") {
    CONTAINER_IMAGE = "0xdolores/react-codespace:2";
  } else if (environment === "nodejs") {
    CONTAINER_IMAGE = "0xdolores/node-codespace:2";
  } else {
          ...
          containers: [
            {
              ...
              ports: [{ containerPort: port }, { containerPort: 5001 }],
  ...
  try {
    ...
    const createdPostgresDeployment =
    ...
    console.log(
      ...
      createdPostgresDeployment.metadata?.name
    );
    ...
    console.log(
      ...
      createdPostgresService.metadata?.name
    );
